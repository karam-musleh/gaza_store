...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            @endphp
            <img width="80" class="prev-img" id="preview" src="{{ $url }}" alt="">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <textarea name="description_en" placeholder="English Description"
                class="form-control @error('description_en') is-invalid @enderror" rows="4"> {{ old('description_en', $product->description_en) }} </textarea>
