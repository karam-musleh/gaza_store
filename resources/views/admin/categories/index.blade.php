...
<table class="table table-bordered table-hover">
   ...
   <tr>
    ...
    <td>
        ...
        {{-- @if ($category->image)
        <img width="100" src="{{asset('images/'.$category->image->path)}}" alt="">
        @endif --}}
    </td>
    ...
    <td>
        ...
        <form class="d-inline" action="{{route('admin.categories.destroy',$category->id)}}" method="POST">
            @csrf
            @method('delete')
            <button onclick="return confirm ('Are you sure')" class="btn-sm btn-danger"><i class="fas fa-trash"></i></button>
        </form>
    </td>
</tr>
    @empty
